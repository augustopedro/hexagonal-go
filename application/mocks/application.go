...
import (
	...
	application "github.com/augustopedro/hexagonal-go/application"
...
// MockProductPersisteceInterface is a mock of ProductPersisteceInterface interface.
type MockProductPersisteceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersisteceInterfaceMockRecorder
}

// MockProductPersisteceInterfaceMockRecorder is the mock recorder for MockProductPersisteceInterface.
type MockProductPersisteceInterfaceMockRecorder struct {
	mock *MockProductPersisteceInterface
}

// NewMockProductPersisteceInterface creates a new mock instance.
func NewMockProductPersisteceInterface(ctrl *gomock.Controller) *MockProductPersisteceInterface {
	mock := &MockProductPersisteceInterface{ctrl: ctrl}
	mock.recorder = &MockProductPersisteceInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersisteceInterface) EXPECT() *MockProductPersisteceInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersisteceInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersisteceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersisteceInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersisteceInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersisteceInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersisteceInterface)(nil).Save), product)
}
